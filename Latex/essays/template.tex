...
%\begin{otherlanguage}{ngerman} Uncomment this  this if you are writing a german essay
...
%Please only use subsection* and/or subsubsection*, since each essay is a section!

% To cite something, write \cite{yourname:keyword} and create a .bib-file in which you put your references. Name it yourname.bib. As soon as you cite something, remove the % of the following line. A very short example is the lib.bib.
...
%\end{otherlanguage} Uncomment this  this if you are writing a german essay
